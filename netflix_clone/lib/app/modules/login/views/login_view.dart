                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: Center(child: Text('Sign in to your account', style: TextStyle(color: Colors.white70, fontSize: 24, fontWeight: FontWeight.w600),))
                      ),
                    ),
                    Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('Do you want to join Netflix?', style: TextStyle(color: Colors.white60),),
                                TextButton(
